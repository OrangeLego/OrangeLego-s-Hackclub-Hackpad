...
# Momentary Switch
momentary_switch = digitalio.DigitalInOut(board.D9)
momentary_switch.direction = digitalio.Direction.INPUT
momentary_switch.pull = digitalio.Pull.UP
...
def encoder_button_macro():
    """Macro for encoder button press"""
    return [Tap(KC.MUTE)]
...
keyboard.keymap = [
    [
        ...
        KC.MACRO(encoder_button_macro),    # Encoder Button: Mute
